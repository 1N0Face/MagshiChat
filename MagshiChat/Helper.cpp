...
// This recieves the type code of the message from socket (3 bytes)
// and returns the code. if no message found in the socket returns 0 (which means the client disconnected)
int Helper::getMessageTypeCode(SOCKET sc)
{
	std::string msg = getPartFromSocket(sc, 3);
	if (msg == "")
		return 0;
...
// This function return string after padding zeros if necessary
...
// This function recieve data from socket according byteSize
std::string Helper::getPartFromSocket(SOCKET sc, int bytesNum)
{
	return getPartFromSocket(sc, bytesNum, 0);
}
// This function recieve data from socket according byteSize and the flags
std::string Helper::getPartFromSocket(SOCKET sc, int bytesNum, int flags)
{
	if (bytesNum == 0)
	{
		return "";
...
//This functions sends data to the socket
